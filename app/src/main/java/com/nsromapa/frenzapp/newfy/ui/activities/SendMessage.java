...
public class SendMessage extends AppCompatActivity {
    ...
    private com.nsromapa.frenzapp.newfy.utils.StringUtils stringUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference= FirebaseStorage.getInstance().getReference()
                .child("notification").child("IMG_"+System.currentTimeMillis()+"_"+random()+".jpg");
        ...
        stringUtils = new com.nsromapa.frenzapp.newfy.utils.StringUtils();
                ...
                if (StringUtils.isNotEmpty(getIntent().getStringExtra("imageUri"))) {
                    ...
                    lottieAnimationView.addAnimatorListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            Toasty.info(SendMessage.this, stringUtils.messege_will_be_sent_after_upload(),
    ...
    private void sendMessage(final String type, final String message_, Uri imageUri, final String c_name,
                             final String c_image, final String current_id, final String user_id) {
        ...
        if(!TextUtils.isEmpty(message_)){
            ...
            if(imageUri==null){
                ...
                }).addOnFailureListener(e -> Toasty.error(SendMessage.this, "Error sending message :(", Toasty.LENGTH_LONG,true).show());
            }
