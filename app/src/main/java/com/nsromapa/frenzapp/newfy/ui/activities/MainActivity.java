...
import com.nsromapa.frenzapp.saytalk.activities.AboutTheDeveloperActivity;
import com.nsromapa.frenzapp.saytalk.activities.CreateChannelActivity;
import com.nsromapa.frenzapp.saytalk.activities.CreateGroupActivity;
import com.nsromapa.frenzapp.saytalk.activities.EditProfile;
import com.nsromapa.frenzapp.saytalk.activities.HomeActivity;
import com.nsromapa.frenzapp.saytalk.activities.SettingsActivity;
import com.nsromapa.frenzapp.saytalk.activities.SplashActivity;
...
public class MainActivity extends
    ...
    public BroadcastReceiver NetworkChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.i("Network receiver", "OnReceive");
                ...
                if (status != NetworkUtil.NETWORK_STATUS_NOT_CONNECTED) {
                    ...
                    try {
                        Snackbar.make(findViewById(R.id.activity_main),
                                "Syncing...", Snackbar.LENGTH_LONG).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                } else {
    ...
    protected void onResume() {
        Pref.INSTANCE.setCurrentTargetUID(this, "");
        FirebaseUtils.INSTANCE.setMeAsOnline();
        ...
        if (!TextUtils.isEmpty(getIntent().getStringExtra("openFragment"))) {
            ...
            if (getIntent().getStringExtra("openFragment").equals("forLike")) {
                startActivity(new Intent(this, SinglePostView.class)
                        .putExtra("post_id", getIntent()
                                .getStringExtra("post_id"))
                        .putExtra("forComment", false));
            } else {
                startActivity(new Intent(this,
                        SinglePostView.class).putExtra("post_id", getIntent()
                        .getStringExtra("post_id"))
                        .putExtra("forComment", true));
            }
        }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (currentuser == null) {
            ...
            FirebaseUtils.INSTANCE.updateFCMToken();
            //check for update
            FirebaseUtils.INSTANCE.checkForUpdate(this, false);
            ...
            if (!TextUtils.isEmpty(getIntent().getStringExtra("openFragment"))) {
                ...
                if (getIntent().getStringExtra("openFragment").equals("forLike")) {
                    startActivity(new Intent(this, SinglePostView.class)
                            .putExtra("post_id", getIntent().getStringExtra("post_id"))
                            .putExtra("forComment", false));
                } else {
                    startActivity(new Intent(this, SinglePostView.class)
                            .putExtra("post_id", getIntent().getStringExtra("post_id"))
    ...
    private void updateToken() {
        ...
        final String token_id = getApplicationContext()
                .getSharedPreferences(Config.SHARED_PREF, MODE_PRIVATE)
                .getString("regId", "");
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.isAnyPermissionPermanentlyDenied()) {
                            Toasty.info(MainActivity.this,
                                    "You have denied some permissions permanently, " +
                                            "if the app force close, try granting permission from settings.", Toasty.LENGTH_LONG, true).show();
                        }
                    }
            ...
            case POS_LOGOUT:
                ...
                if (currentuser != null && isOnline()) {
                    ...
                    new MaterialDialog.Builder(this)
                            .title("Logout")
                            .content("Do you want to logout from this account?")
                            .positiveText("Yes")
                    ...
                    new MaterialDialog.Builder(this)
                            .title("Logout")
                            .content("A technical error occurred while logging you out, Check your network connection and try again.")
                            .positiveText("Done")
    ...
    public void logout() {
        ...
        firestore.collection("Users").document(userId)
                .update(tokenRemove).addOnSuccessListener(aVoid -> {
    ...
    protected void onPause() {
        if (utils.INSTANCE.isAppIsInBackground(this)) {
            FirebaseUtils.INSTANCE.setMeAsOffline();
        }
            ...
            if (!validate) {
                ...
                FirebaseFirestore.getInstance()
                        ...
                        .addOnSuccessListener(documentSnapshot -> {
                            ...
                            if(TextUtils.isEmpty(emai) ||TextUtils.isEmpty(usernam) ||
                                    (TextUtils.isEmpty(imag) && TextUtils.isEmpty(nam) ||
                            TextUtils.isEmpty(email) ||TextUtils.isEmpty(usrname) ||
                                    (TextUtils.isEmpty(image) && TextUtils.isEmpty(name) ))){
                                Toasty.error(this,
                                ...
                                intent.putExtra(utils.constants.KEY_IS_ON_ACCOUNT_CREATION,true);
                                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            storageReference.getDownloadUrl().addOnSuccessListener(downloadUri -> {
                                                ...
                                                FirebaseFirestore.getInstance().collection("Users")
                                                        .document(userId).update(userMap).addOnSuccessListener(aVoid -> {

                                                    Map<String,Object> map2=new HashMap<>();
                                                    map2.put("profile_pic_url",downloadUri.toString());
                            ...
                            if (!name.equals(nam)) {
                                ...
                                FirebaseFirestore.getInstance().collection("Users")
                                        .document(userId).update(userMap)
                                        .addOnSuccessListener(aVoid -> {

                                            Map<String,Object> map2=new HashMap<>();
                                            map2.put("full_name", nam);
                                            userRef.updateChildren(map2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        badge_action.setOnClickListener(v -> {
