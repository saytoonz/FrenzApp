...
public class SendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirestore.collection("Users").document(user_id).get().addOnSuccessListener(documentSnapshot -> {
            ...
            Objects.requireNonNull(getSupportActionBar()).setTitle(f_name);
            toolbar.setTitle(documentSnapshot.getString("name"));

            toolbar.setOnClickListener(v -> FriendProfile.startActivity(SendActivity.this,user_id));
        ...
        mSend.setOnClickListener(view -> {
            ...
            if(!TextUtils.isEmpty(message_)){
                ...
                if(imageUri==null){
                    ...
                    SendMessage.startActivity(SendActivity.this,"normal_message",message_,
                            c_name,c_image,current_id,user_id);
                    //Send only message
                    message.setText("");
                    ...
                    SendMessage.startActivity(SendActivity.this,"normal_message",message_,
                            imageUri,c_name,c_image,current_id,user_id,f_name);
            ...
            if(resultCode==RESULT_OK){
                new MaterialDialog.Builder(this)
                        ...
                        .onPositive((dialog, which) -> {
                            ...
                            text.setVisibility(View.GONE);
                            imageUri=data.getData();
                            Toasty.info(SendActivity.this, "Long press to remove attachment", Toasty.LENGTH_SHORT,true).show();
