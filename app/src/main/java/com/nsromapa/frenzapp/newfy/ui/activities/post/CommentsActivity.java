...
public class CommentsActivity extends AppCompatActivity {
    ...
    public static void startActivity(Context context, List<Post> post,
                                     String desc, int pos, boolean owner) {
    ...
    private void sendNotification() {
        ...
        mFirestore.collection("Notifications")
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    addToNotification(user_id,mCurrentUser.getUid(),image,username, post_id);
    ...
    private void addToNotification(String admin_id,
        ...
        map.put("message", "Commented on your post");
    ...
    private void setupCommentView() {
        ...
        RecyclerView mCommentsRecycler = findViewById(R.id.recyclerView);
        mCommentText = findViewById(R.id.text);
        MaterialButton mCommentsSend = findViewById(R.id.send);
        ...
        mFirestore.collection("Users")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        commentMap.put("id", Objects.requireNonNull(documentSnapshot.getString("id")));
                        commentMap.put("username", Objects.requireNonNull(documentSnapshot.getString("username")));
                        commentMap.put("image", Objects.requireNonNull(documentSnapshot.getString("image")));
