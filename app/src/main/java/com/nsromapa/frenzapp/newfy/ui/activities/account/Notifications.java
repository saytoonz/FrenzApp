...
public class Notifications extends AppCompatActivity {
        ...
        FirebaseFirestore.getInstance().collection("Users")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    getSharedPreferences("Notifications",MODE_PRIVATE)
                            .edit().putInt("count",queryDocumentSnapshots.size()).apply();
                    ...
                    if(!queryDocumentSnapshots.isEmpty()){
                        ...
                        for(DocumentChange documentChange:queryDocumentSnapshots.getDocumentChanges()){
                            ...
                            if(documentChange.getType()== DocumentChange.Type.ADDED){
                                ...
                                Notification notification=documentChange.getDocument()
                                        .toObject(Notification.class).withId(documentChange.getDocument().getId());
                    ...
                    if(!queryDocumentSnapshots.isEmpty()){
                        ...
                        for(DocumentChange documentChange:queryDocumentSnapshots.getDocumentChanges()){
                            ...
                            FirebaseFirestore.getInstance().collection("Users")
                                    ...
                                    .delete()
                                    .addOnSuccessListener(aVoid -> refreshLayout.setRefreshing(false))
                        ...
                        notificationsList.clear();
                        findViewById(R.id.default_item).setVisibility(View.VISIBLE);
                        Toasty.success(getApplicationContext(),"Notifications cleared",
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        refreshLayout.setOnRefreshListener(this::getNotifications);
