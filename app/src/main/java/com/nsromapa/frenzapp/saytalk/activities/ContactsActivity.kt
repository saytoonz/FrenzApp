                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    for (post in p0.children){
                        ...
                        for((index, item) in numberList.withIndex()) {
                            if (item.number == number || item.number.contains(number)|| number.contains(item.number)) {
                    ...
                    registeredAvailableUser.add(2, Models.Contact("New Channel"))
    ...
    val adapter = object : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            when(position){
                ...
                2-> {
                    holder.pic.setImageResource(R.drawable.ic_channel)
                    holder.pic.circleBackgroundColor = ContextCompat.getColor(this@ContactsActivity,
                            R.color.colorPrimary
                    )
                }
            ...
            holder.itemView.setOnClickListener {
                ...
                when (position) {
                    ...
                    2  -> {
                        //new Channel
                        startActivity(Intent(this@ContactsActivity, CreateChannelActivity::class.java))
                        finish()
                    }
